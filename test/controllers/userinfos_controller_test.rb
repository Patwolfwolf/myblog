...
class UserinfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userinfo" do
    assert_difference('Userinfo.count') do
      post userinfos_url, params: { userinfo: { name: @userinfo.name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update userinfo" do
    patch userinfo_url(@userinfo), params: { userinfo: { name: @userinfo.name, password: 'secret', password_confirmation: 'secret' } }
